...
if (isset($_POST['create'])) {
 ...
 <html lang="ja">
   ...
   <body>
     ...
     echo "</ul>" ;
     echo '<form class="" action="create.php" method="post">
      ...
      <div class="">
        ...
        <a href="../folder/list.php">フォルダリストへ</a><br>
 ...
 <!-- <input type="checkbox" name="" value="">お米買う
 <input type="checkbox" name="" value="">お茶っぱ買う
 <input type="checkbox" name="" value="">飲み物買う
 <input type="checkbox" name="" value="">ご飯 -->
